...
public class IzinSelesai extends Fragment {
    ...
    public void onStart(){
        ...
        options = new FirebaseRecyclerOptions.Builder<Izin>()
                .setQuery(DataRef, Izin.class).build();
